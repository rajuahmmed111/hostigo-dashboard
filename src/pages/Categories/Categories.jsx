              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {categories.map((category) => (
                  <tr key={category.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{category.vehicles} vehicles</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
            ...
            {selectedCategory.vehicles > 0 && (
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
                <p className="text-yellow-700">
                  <span className="font-medium">Note:</span> This category contains {selectedCategory.vehicles} vehicle(s). 
                  Deleting it will remove these vehicles from this category.
                </p>
              </div>
            )}
          </div>
